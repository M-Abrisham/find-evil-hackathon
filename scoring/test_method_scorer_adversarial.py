...
class TestTwoArtifactTypesInOneCommandCountAsTwo(unittest.TestCase):  # leak-scan: allow secret.entropy
...
class TestPersistedOnlyIsUnverifiableNotFabrication(unittest.TestCase):  # leak-scan: allow secret.entropy
...
# ===========================================================================
class TestBenignObjectNearMaliceKeyword(unittest.TestCase):  # leak-scan: allow secret.entropy
...
class TestChainOfCustodyExcluded(unittest.TestCase):  # leak-scan: allow secret.entropy
...
class TestEmptyReceiptsSoftNeverHardFail(unittest.TestCase):  # leak-scan: allow secret.entropy
